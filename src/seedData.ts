...
const SEED_EXPERIENCE: Partial<Experience> = {
  ...
  period: '2021 - Present',
  field: '기업 홍보, 브랜드 필름, 교육 및 인터뷰 콘텐츠',
  scope: '기획안 작성, 스토리보드 구성, 현장 연출, 포스트 프로덕션(편집/색보정)',
  strengths: '메시지 구조화, 브랜드 톤앤매너 유지, AI 툴을 활용한 제작 효율화',
  brands: 'AIA생명, 현대글로비스, 닥터지, 삼성셀레나영어, 한국로봇산업진흥원 등'
};
...
const SEED_PROFILE: Partial<Profile> = {
  ...
  about_subtitle: '본질에 집중할 때 비로소 선명해지는 브랜드의 가치.',
  about_text: '좋은 영상은 화려한 효과보다 탄탄한 기획에서 시작된다고 믿습니다. 저는 브랜드가 전달하고자 하는 핵심 메시지를 파악하고, 이를 가장 효과적인 비주얼로 구현하는 데 집중합니다. 기획 단계부터 참여하여 최종 마스터링까지, 일관된 톤앤매너로 브랜드의 신뢰도를 높이는 파트너가 되겠습니다.',
